/*
 * ReadBlockGetterDAA.java Copyright (C) 2026 Daniel H. Huson
 *
 ...
 *
 */
package megan8.daa.connector;

import jloda.util.Basic;
import jloda.util.ByteInputBuffer;
import jloda.util.Pair;
import megan8.daa.io.*;
import megan8.data.IReadBlock;
import megan8.data.IReadBlockGetter;
...
public class ReadBlockGetterDAA implements IReadBlockGetter {
	...
	public IReadBlock getReadBlock(long uid) throws IOException {
		...
		if (reader.getPosition() < end) {
			...
			readBlock.setFromQueryAndMatchRecords(pair.getFirst(), pair.getSecond(), wantReadSequences, wantMatches, minScore, maxExpected);
			return readBlock;
		}
		return null;
	}
