/*
 * InputReaderLittleEndian.java Copyright (C) 2026 Daniel H. Huson
 *
...
import megan8.io.ByteByteInt;
import megan8.io.IInput;
import megan8.io.IInputReader;
...
public class InputReaderLittleEndian implements Closeable, IInputReader {
	...
	@Override
	public ByteByteInt readByteByteInt() {
		return null;
	}
