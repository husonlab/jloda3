/*
 *  TriangularTreeLayout.java Copyright (C) 2026 Daniel H. Huson
 *
...
public class TriangularTreeLayout {
	 ...
	 */
	public static void apply(PhyloTree tree, Map<Node, Point2D> nodePointMap) {
		if (tree.hasReticulateEdges())
			System.err.println("Warning TriangularTreeLayout: tree has reticulate edges.");
