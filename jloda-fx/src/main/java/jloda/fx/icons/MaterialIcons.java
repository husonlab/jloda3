...
public enum MaterialIcons {
	...
	MaterialIcons(String codeStr) {
		codePoint = String.valueOf((char) Integer.parseInt(codeStr, 16));
	}
	...
	public static Node graphic(String materialIconName, String style) {
		return graphic(valueOf(materialIconName), style);
	}

	public static Node graphic(MaterialIcons icon) {
		return graphic(icon, null);
	}

	public static Node graphic(MaterialIcons icon, String style) {
		var label = new Label(icon.codePoint);
	...
	public static void setIcon(Labeled labeled, MaterialIcons icon) {
