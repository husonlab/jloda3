/*
 * IdParser.java Copyright (C) 2026 Daniel H. Huson
 *
...
import jloda.megan.classification.util.MultiWords;
import jloda.megan.classification.util.TaggedValueIterator;
