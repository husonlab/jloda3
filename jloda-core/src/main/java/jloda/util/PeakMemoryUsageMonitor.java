/*
 * PeakMemoryUsageMonitor.java Copyright (C) 2026 Daniel H. Huson
 *
...
public class PeakMemoryUsageMonitor {
    ...
    public static String getPeakUsageString() {
        ...
        if (available < 1024) {
            ...
            return StringUtils.trim(String.format("%.1f of %.1f", (double) peak / 1024.0, (double) available / 1024.0)) + "G";
        }
    }
